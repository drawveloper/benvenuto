(function() {
  var benchmark, coffeecup, coffeecup_compiled_template, coffeecup_optimized_template, coffeecup_string_template, coffeecup_template, data, eco, eco_compiled_template, eco_template, ejs, ejs_template, haml, haml_template, haml_template_compiled, jade, jade_compiled_template, jade_template, log;
  ...
  benchmark('Eco (precompiled)', function() {
    return eco_compiled_template(data);
  });

  console.log('\n');

  benchmark('coffeecup (function, cache on)', function() {
    return coffeecup.render(coffeecup_template, data, {
      cache: true
    });
  });

  benchmark('coffeecup (string, cache on)', function() {
    return coffeecup.render(coffeecup_string_template, data, {
      cache: true
    });
  });
  ...
  benchmark('coffeecup (function, cache off)', function() {
    return coffeecup.render(coffeecup_template, data, {
      cache: false
    });
  });

  benchmark('coffeecup (string, cache off)', function() {
    return coffeecup.render(coffeecup_string_template, data, {
      cache: false
    });
  });
